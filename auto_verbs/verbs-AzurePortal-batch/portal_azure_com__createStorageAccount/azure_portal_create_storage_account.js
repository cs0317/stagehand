 ...
 * and creates a new storage account.
 */
...
def azure_portal_create_storage_account(
    ...
    try:
        ...
        # Wait for validation — check for an enabled Create button (exact text match)
        final_create = None
...
const pyPath = path.join(__dirname, "azure_portal_create_storage_account.py");
