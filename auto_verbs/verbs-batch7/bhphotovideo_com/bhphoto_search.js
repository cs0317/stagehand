 ...
 *
 * Searches bhphotovideo.com for products and extracts:
 * product name, price, customer rating, availability status.
 */
...
(async () => {
  ...
  try {
    ...
    const result = await stagehand.extract({
      instruction: `Extract the first ${CFG.maxProducts} product search results. For each get: product name, price, customer rating/reviews, and availability status.`,
      schema: {
        type: "object",
        properties: {
          products: {
    ...
    fs.writeFileSync(path.join(outDir, "bhphoto_search.py"), genPython(CFG, recorder));
    console.log("Saved recorded_actions.json and bhphoto_search.py");
  } finally {
