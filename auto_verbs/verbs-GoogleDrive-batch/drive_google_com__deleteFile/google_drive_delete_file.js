 ...
 *
 * Generates the Python Playwright script that moves a file to trash
 * in Google Drive via right-click > Move to trash.
 */
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  Google Drive – Delete File (generate Python)");
  console.log("═══════════════════════════════════════════════════════════════\n");

  const pyCode = genPython();
  const outPath = path.join(__dirname, "google_drive_delete_file.py");
