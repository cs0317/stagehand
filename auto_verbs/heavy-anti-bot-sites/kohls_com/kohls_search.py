"""Kohl's – Product Search. Uses Playwright via CDP."""
import re, os, sys, shutil
from playwright.sync_api import Playwright, sync_playwright
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
from cdp_utils import get_free_port, get_temp_profile_dir, launch_chrome, wait_for_cdp_ws

def run(playwright: Playwright, query: str = "kitchen appliances", max_results: int = 5) -> list:
    print(f"  Query: {query}\n")
    ...
    results = []
    try:
        page.goto("https://www.kohls.com"); page.wait_for_load_state("domcontentloaded"); page.wait_for_timeout(2000)
