"""
Allbirds – Best Sellers (typed verb)
...
# collection page. For each product, extracts the name, product handle, current
# price, compare-at (original) price when on sale, and detail page URL.
...
def test_get_allbirds_best_sellers() -> None:
    ...
    port = get_free_port()
    profile_dir = get_temp_profile_dir("allbirds_com")
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            # Bestsellers page may have fewer than max_results distinct items;
            # accept any non-empty count up to the requested max.
...
if __name__ == "__main__":
    test_get_allbirds_best_sellers()
