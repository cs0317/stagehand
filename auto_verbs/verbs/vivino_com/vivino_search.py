...
def search_vivino(
    ...
    Parameters:
        search_term: Wine to search for (e.g. "Pinot Noir").
        max_results: Maximum number of wine listings to extract.

    Returns:
        List of dicts with keys: wine_name, winery, region, average_rating,
        num_ratings, price.
    """
    port = get_free_port()
