 ...
 *
 * Generates the Python Playwright script that searches for a file
 * and opens the first matching result.
 */
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  Google Drive – Open File (generate Python)");
  console.log("═══════════════════════════════════════════════════════════════\n");

  const pyCode = genPython();
  const outPath = path.join(__dirname, "google_drive_open_file.py");
