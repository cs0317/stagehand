...
(async () => {
  ...
  try {
    ...
    const url = `https://www.tastingtable.com/?s=${query}`;
    ...
    fs.writeFileSync(path.join(outDir, "tastingtable_search.py"), genPython(CFG, recorder));
    console.log("Saved tastingtable_search.py");
  } finally {
