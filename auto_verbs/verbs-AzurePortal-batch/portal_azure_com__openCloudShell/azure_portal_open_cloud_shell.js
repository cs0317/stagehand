 ...
 *
 * Generates the Python Playwright script that opens Cloud Shell in Azure Portal,
 * runs a command, and extracts the output.
 */
...
const pyPath = path.join(__dirname, "azure_portal_open_cloud_shell.py");
