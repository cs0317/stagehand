 ...
 *
 * Generates the Python Playwright script that uploads a file to Google Drive
 * via the "+ New" button > "File upload".
 */
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  Google Drive – Upload File (generate Python)");
  console.log("═══════════════════════════════════════════════════════════════\n");

  const pyCode = genPython();
  const outPath = path.join(__dirname, "google_drive_upload_file.py");
