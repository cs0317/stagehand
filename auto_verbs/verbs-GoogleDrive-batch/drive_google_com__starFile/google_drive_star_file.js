 ...
 *
 * Generates the Python Playwright script that stars a file
 * in Google Drive via right-click > Add to Starred.
 */
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  Google Drive – Star File (generate Python)");
  console.log("═══════════════════════════════════════════════════════════════\n");

  const pyCode = genPython();
  const outPath = path.join(__dirname, "google_drive_star_file.py");
