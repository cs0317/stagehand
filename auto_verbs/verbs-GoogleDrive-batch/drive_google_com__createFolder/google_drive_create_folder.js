 ...
 *
 * Generates the Python Playwright script that creates a new folder
 * in Google Drive via the "+ New" button > "New folder".
 */
...
async function main() {
  console.log("═══════════════════════════════════════════════════════════════");
  console.log("  Google Drive – Create Folder (generate Python)");
  console.log("═══════════════════════════════════════════════════════════════\n");

  const pyCode = genPython();
  const outPath = path.join(__dirname, "google_drive_create_folder.py");
