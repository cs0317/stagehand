...
(async () => {
  ...
  try {
    ...
    const url = `https://www.hunker.com/search?q=${queryEncoded}`;
    ...
    fs.writeFileSync(path.join(outDir, "hunker_search.py"), genPython(CFG, recorder));
    console.log("Saved hunker_search.py");
  } finally {
