...
(async () => {
  ...
  try {
    const searchUrl = `https://www.google.com/search?q=site%3Anoaa.gov+${encodeURIComponent(CFG.query)}`;
    console.log(`\n🌐 Loading: ${searchUrl}...`);
    await page.goto(searchUrl, { waitUntil: "domcontentloaded", timeout: 30000 });
    await page.waitForTimeout(CFG.waits.page);
    recorder.record("goto", { url: searchUrl, description: "Navigate to Google site search for NOAA" });
    ...
    fs.writeFileSync(path.join(dir, "noaa_search.py"), pyCode);
